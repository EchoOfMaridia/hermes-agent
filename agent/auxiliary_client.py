...
# 31 missing top-level symbols (functions, classes, constants) appended in topo order so each symbol's dependencies come first. Source: upstream/main @ HEAD. Per user's 5-rule policy, these are
...
# === Restored from upstream/main @agent/auxiliary_client.py (line 2462) ===
# Top-level binding lost by ours-wins catchup merge.
_RUNTIME_MAIN_AUTH_MODE: str = ""

# === Restored from upstream/main @agent/auxiliary_client.py (line 2463) ===
# Top-level binding lost by ours-wins catchup merge.
...
# === Restored from upstream/main @agent/auxiliary_client.py (line 2466) ===
# Top-level binding lost by ours-wins catchup merge.
