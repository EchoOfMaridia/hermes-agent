...
class WorkflowRuntime:
    ...
    def set_dispatcher(self, dispatcher: Callable[[Any], None] | None
        ...
        prior = getattr(self, "_dispatcher", None)
        self._dispatcher = dispatcher
        _logging.getLogger("hermes_workflow.runtime").info(
            "WorkflowRuntime.set_dispatcher prior=%s new=%s (run_id=%s)",
            type(prior).__name__ if prior is not None else None,
