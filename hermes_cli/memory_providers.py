...
# Aliases (Declarative/Declared variants used by consumer code)
DeclaredMemoryProvider = MemoryProvider
DeclaredProviderField = ProviderField
get_declared_memory_provider = get_memory_provider
