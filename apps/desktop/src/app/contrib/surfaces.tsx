...
/** WorkflowsView with a close handler that navigates back to chat. */
const WorkflowsRoute = memo(function WorkflowsRoute() {
  const navigate = useNavigate()
  return <WorkflowsView onClose={() => navigate(NEW_CHAT_ROUTE)} />
})
