  ...
  return useCallback(
    (event: RpcEvent) => {
      ...
      if (event.type === 'gateway.ready') {
        ...
        // Update $currentUsage in real time as the model consumes context.
        // Gate to isActiveEvent so background session deltas don't clobber
        // the foreground pill's usage display.
