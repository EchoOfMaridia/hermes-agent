...
export const en: Translations = {
  ...
  shell: {
    ...
    statusbar: {
      ...
      workflowsRunning: count => `${count} running`,
      turnRunning: 'Running',
  ...
  desktop: {
    ...
    // /fast — mirrors ui-tui/.../slash/commands/session.ts:450 (cli.py:_show_fast / _set_fast).
    fastStatus: mode => `fast mode: ${mode}`,
    fastSet: mode => `fast mode: ${mode}`,
    // /busy — mirrors ui-tui/.../slash/commands/session.ts:493 (cli.py:_show_busy / _set_busy).
    busyStatus: mode => `busy input mode: ${mode}`,
    busySet: mode => `busy input mode: ${mode}`,
    // /voice — mirrors ui-tui/.../slash/commands/session.ts:255 (cli.py:_show_voice_status / _enable_voice_mode / _toggle_voice_tts).
