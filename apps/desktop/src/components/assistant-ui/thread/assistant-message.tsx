...
export const AssistantMessage: FC<{
  ...
  // Hermes desktop (2026-08-03): each stalled message used to render its own
  // StreamStallIndicator — they stacked as N icons when multiple turns were
  // in flight. Only the latest assistant turn owns the indicator now.
  const isLatestAssistantTurn = useAuiState(s => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        {isPlaceholder ? <ResponseLoadingIndicator /> : isRunning && isLatestAssistantTurn && <StreamStallIndicator />}
